  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[250px] md:w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0  border-slate-700 px-8 py-6 "
            style={{
              background:
            ...
            <blockquote>
              ...
              <div className="relative z-20 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className=" text-sm mt-3 leading-[1.6] text-gray-300 font-normal">
                    {item.title}
                  </span>
